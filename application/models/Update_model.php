...
class Update_model extends CI_Model
{
    public function getFile()
    {
        ...
        //$xlsx_full = new SimpleXLSX(FCPATH . "assets/xlsx/Kanji_N4_edit.xlsx");
        $xlsx_k = new SimpleXLSX(FCPATH . "assets/xlsx/Kana.Hiragana.Sheet.xlsx");
...
/* запись в новый файл */
        ...
        $writer->writeToFile(FCPATH . "assets/xlsx/Kanji_N4_edit.xlsx");
        // if($writer->writeToFile(FCPATH . "assets/xlsx/Kanji_N4_edit.xlsx")){
        //     $ss = true;
        // }else{
        //     $ss = false;
        // }
